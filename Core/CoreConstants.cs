...
<MudText Typo=""Typo.h5"">Battery Service</MudText>
<MudButton Variant = ""Variant.Filled"" Color=""Color.Primary"" OnClick=""ConnectBLE"">Connect BLE</MudButton>
<MudText Typo=""Typo.h6"">Battery level is: @batterylevel.ToString()</MudText>

@code { 
    private int batterylevel = 0;

    protected async Task ConnectBLE()
    {
        ...
        var device = await ble.RequestDeviceAsync(q);

        await ble.SetupNotifyAsync(device.Id, serviceid, characteristics);
        ble.Notification += ValueNotification;
    }

    private void ValueNotification(object sender, CharacteristicEventArgs e)
    {
